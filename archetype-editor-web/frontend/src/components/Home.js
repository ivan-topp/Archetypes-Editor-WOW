...
import { changeTitle, toggleOpenFileDialog, saveFile, handlerDownload } from '../actions/home';
    ...
    render(){
        return (
            <div>
                ...
                <Button type="primary" onClick={()=>{this.props.handlerDownloadFile(this.props.currentFile, this.props.files)}}><Icon type="download" />Donwload</Button>
                <FileManager />
